...
Read `~/.codex/skills/banyan/AGENTS.md` (invariants 2, 3, 5, and 6; §2.2 recovery),
`~/.codex/skills/banyan/skills/bn-conventions/references/envelope.md`, and
`~/.codex/skills/banyan/skills/bn-conventions/references/ledger.md`; skip any already in
your context.
