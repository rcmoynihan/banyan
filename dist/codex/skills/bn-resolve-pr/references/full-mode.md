...
Throughout, `<scripts>` means `~/.codex/skills/banyan/skills/bn-resolve-pr/scripts`.
...
```bash
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs resolve-pr-<PR_NUMBER> \
  --root <repo-root> \
