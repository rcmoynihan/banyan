...
| `doctrine` | Resolved paths to the Banyan doctrine and required convention references. Include `~/.codex/skills/banyan/AGENTS.md` whenever the child needs Banyan invariants, lead pattern, protected artifacts, or recovery doctrine; do not rely on a bare `AGENTS.md`, which belongs to the host repo. |
...
the host repo's instructions; `~/.codex/skills/banyan/AGENTS.md` is Banyan's shipped runtime
doctrine.
