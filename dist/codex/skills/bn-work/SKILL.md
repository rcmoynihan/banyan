...
`~/.codex/skills/banyan/AGENTS.md` (esp. invariant 3 artifacts-over-prose, invariant 6
...
- **Boundary check script.** Resolve the absolute path
  `~/.codex/skills/banyan/skills/bn-conventions/scripts/check-boundary.mjs` and record it
...
```
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs work-<slug> \
  --root <repo-root> \
