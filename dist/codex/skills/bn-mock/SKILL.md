...
- `~/.codex/skills/banyan/skills/bn-mock/references/fidelity-doctrine.md` — the anti-real-machine
  boundary (passed to the builder).
- `~/.codex/skills/banyan/skills/bn-mock/references/mock-notes-schema.md` — the gate-artifact schema.
- `~/.codex/skills/banyan/skills/bn-mock/references/overwrite-safety.md` — the pre-build
  overwrite-safety gate.
- `~/.codex/skills/banyan/skills/bn-mock/references/handoff.md` — the disposition/routing rules.
...
```
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs mock-<slug> --root <repo-root> [--run-id <run-id>]
```
