...
- `~/.codex/skills/banyan/skills/bn-poc/references/fidelity-doctrine.md` — the derived per-PoC
  boundary, the cliffs, and the no-sandbox acknowledgment (passed to the builder).
- `~/.codex/skills/banyan/skills/bn-poc/references/poc-notes-schema.md` — the gate-artifact schema.
- `~/.codex/skills/banyan/skills/bn-poc/references/overwrite-safety.md` — the pre-build
  overwrite-safety gate.
- `~/.codex/skills/banyan/skills/bn-poc/references/handoff.md` — the verdict-keyed routing rules.
...
```
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs poc-<slug> --root <repo-root> [--run-id <run-id>]
```
...
doctrine:        ~/.codex/skills/banyan/skills/bn-poc/references/fidelity-doctrine.md,
                 ~/.codex/skills/banyan/skills/bn-poc/references/poc-notes-schema.md,
