...
Read `~/.codex/skills/banyan/AGENTS.md` (esp. invariant 1 context-centric decomposition,
...
`~/.codex/skills/banyan/skills/bn-conventions/references/ledger.md`, and
`~/.codex/skills/banyan/skills/bn-conventions/references/envelope.md` (skip any already in your context). The phases you
...
just do the work — that is the violation `~/.codex/skills/banyan/AGENTS.md` §2.4 exists to
...
```
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs grow-<slug> \
  --root <repo-root> \
...
~/.codex/skills/banyan/skills/bn-conventions/references/ledger.md` (see
...
ladder (see `~/.codex/skills/banyan/skills/bn-conventions/references/consult-protocol.md`)
