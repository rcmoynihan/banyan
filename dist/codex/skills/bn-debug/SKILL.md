...
```
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs debug-<slug> \
  --root <repo-root> \
...
inputs:
  ...
  methodology:   ~/.codex/skills/banyan/skills/bn-debug/references/investigation-techniques.md,
                 ~/.codex/skills/banyan/skills/bn-debug/references/anti-patterns.md,
                 ~/.codex/skills/banyan/skills/bn-debug/references/defense-in-depth.md
