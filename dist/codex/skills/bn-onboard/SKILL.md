...
- `~/.codex/skills/banyan/skills/bn-conventions/references/knowledge-store.md`
- `~/.codex/skills/banyan/skills/bn-onboard/references/classification.md`
- `~/.codex/skills/banyan/skills/bn-onboard/references/manifest.md`
...
```bash
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs onboard-<repo-slug> \
  --root <root> \
...
tool_guidance:   Read assigned sources and required references. Use Bash only to run
                 python ~/.codex/skills/banyan/skills/bn-conventions/scripts/validate-frontmatter.py on
