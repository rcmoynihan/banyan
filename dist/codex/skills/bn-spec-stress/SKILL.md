...
Read `~/.codex/skills/banyan/AGENTS.md` (especially protected artifacts, the lead pattern,
and self-recovery),
`~/.codex/skills/banyan/skills/bn-conventions/references/envelope.md`, and
`~/.codex/skills/banyan/skills/bn-conventions/references/ledger.md` (skip any already in your context). The trunk is the single writer of the final
...
```bash
node ~/.codex/skills/banyan/skills/bn-conventions/scripts/new-run.mjs spec-stress-<slug> \
  --root <repo-root> \
